...
public class Main implements ApplicationListener {
    ...
    private String data = "/home/faraz/libraries/fbx-conv-linux";
    ...
    public void create() {
        ...
        assets.load(data + "/chicago2.g3db", Model.class);
        loading = true;
    }

    private void doneLoading() {
        Model model = assets.get(data + "/chicago2.g3db", Model.class);
