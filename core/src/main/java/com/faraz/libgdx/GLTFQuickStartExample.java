...
public class GLTFQuickStartExample extends ApplicationAdapter
{
    ...
    public void create() {
        ...
        // create scene
//        sceneAsset = new GLTFLoader().load(Gdx.files.internal("/home/faraz/Documents/glTF files/chicago2 " +
//            "glTF/result.gltf"));
        sceneAsset = new GLBLoader().load(Gdx.files.internal("/home/faraz/Android/code-workspace/libgdx-tutorial" +
            "/assets/data/ok2.glb"));
...
//        camera.up.set(Vector3.Y);
        camera.position.set(0f, 3000f, 2000f);
